...
console.log(`The number of times really appeared: ${rcount}`)

console.log(`The number of times very appeared: ${vcount}`)

console.log(`The number of times basically appeared: ${bcount}`)
